...
// import DestinationText from "../js/destiText.js";
//Filter
  ...
  data.forEach(post => {
    ...
    postBox.innerHTML = `
      <div class="post-box ${post.category}">
        ...
        <a href="blog.html?id=${post.id}" class="post-title">${post['post-title']}</a>
...
const thumbnailsSwiper = new Swiper2(".home__thumbnails", {
  slidesPerView: 3.5,
  spaceBetween: 20,
  loop: true,
  effect: "carousel",
